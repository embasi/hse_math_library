//-------------------------------------------------------
//Заголовочный файл с описанием класса Матрица, его методов и подклассов
//-------------------------------------------------------
...
protected:
	...
	vector<vector<double>> matrix; //для хранения элементов
...
public:
	...
	//конструктор с параметрами: число строк и столбцов, вектор элементов
...
//Метод для вычисления произведения Адамара
...
//-------------------------------------------------------
//Описание подклассов класса Матрица
//-------------------------------------------------------
